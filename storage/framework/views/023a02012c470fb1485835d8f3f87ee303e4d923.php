...
unset($__errorArgs, $__bag); ?>"
                           placeholder="Название" value="<?php echo e(old('name')); ?>">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text">
                        <i class="ri-pencil-line"></i>
...
unset($__errorArgs, $__bag); ?>"
                           placeholder="Цена" value="<?php echo e(old('cost')); ?>">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text">Описание</span>
                    <textarea name="description" class="form-control"
                              aria-label="With textarea" rows="5"><?php echo e(old('description')); ?></textarea>
                </div>
...
unset($__errorArgs, $__bag); ?>"
                           name="image" id="input-avatar" required>
                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ellidey/web/garden/resources/views/admin/items/create.blade.php ENDPATH**/ ?>